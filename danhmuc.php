...
$title = isset($row_title['category_name']) ? $row_title['category_name'] : 'Danh mục không tồn tại';
?>
<!-- top Products -->
									...
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price"><?php echo number_format((float)$row_sanpham['sanpham_giakhuyenmai']) . 'vnđ' ?></span>
												<del><?php echo number_format((float)$row_sanpham['sanpham_gia']) . 'vnđ' ?></del>
											</div>
