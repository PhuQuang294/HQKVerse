	...
	<div class="container-fluid">
		<div class="row">
			...
			if (isset($_GET['quanly']) == 'xemdonhang') {
				$mahang = $_GET['mahang'];
				$sql_chitiet = mysqli_query($con, "SELECT * FROM tbl_donhang,tbl_sanpham,tbl_giaodich
				 WHERE tbl_donhang.sanpham_id=tbl_sanpham.sanpham_id AND tbl_donhang.mahang=tbl_giaodich.magiaodich AND tbl_donhang.mahang='$mahang'");
			?>
				<div class="col-md-7">
						...
						<table class="table table-bordered ">
							...
							?>
								<tr>
									...
									<td style="color:red"><?php echo $row_donhang['payment_method']; ?></td>
			...
			<div class="col-md-5">
				...
				<?php
				$sql_select = mysqli_query($con, "SELECT * FROM tbl_sanpham,tbl_khachhang,tbl_donhang,tbl_giaodich
				 WHERE tbl_donhang.sanpham_id=tbl_sanpham.sanpham_id AND tbl_donhang.khachhang_id=tbl_khachhang.khachhang_id 
				 AND tbl_donhang.mahang = tbl_giaodich.magiaodich
