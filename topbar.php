            ...
            <div class="col-lg-8 header-right mt-lg-0 mt-2">
                ...
                <ul>
                    ...
                    ?>
                        ...
                        <li class="text-center border-right text-white">
                            <a href="?quanly=giohang&dangxuat=true" class="text-white">
            ...
            <div class="col-md-3 logo_agile">
                <h1 class="text-center">
                    <a href="index.php" class="font-weight-bold font-italic">
                        <img src="images/logo2.png" alt=" " class="img-fluid">HQKVerse
                    </a>
                </h1>
            </div>
            <!-- //logo -->
                ...
                <div class="row">
                    ...
                    <div class="col-2 top_nav_right text-center mt-sm-0 mt-2">
                        <div class="wthreecartaits wthreecartaits2 cart cart box_1">
                            <a href="index.php?quanly=giohang" class="btn w3view-cart">
                                ...
                                <span id="cart-count">
                                    ...
                                    echo $row_cart_count['total_items'] ? $row_cart_count['total_items'] : 0;
                                    ?>
                                </span>
                            </a>
                        </div>
